...
function isSeverityLevel(x) {
    return (0, type_utils_1.isString)(x) && !(0, type_utils_1.isEmptyString)(x) && types_1.severityLevels.indexOf(x) >= 0;
}
...
function errorToProperties(_a, metadata) {
    ...
    else if ((0, type_utils_1.isUndefined)(error) && (0, type_utils_1.isString)(event)) {
        var name_2 = 'Error';
        var message = event;

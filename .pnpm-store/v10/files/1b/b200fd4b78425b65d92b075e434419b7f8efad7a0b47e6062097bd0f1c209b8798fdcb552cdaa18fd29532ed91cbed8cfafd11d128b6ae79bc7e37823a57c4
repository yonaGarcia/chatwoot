...
var RetryQueue = /** @class */ (function () {
    function RetryQueue(_instance) {
        ...
        if (!(0, type_utils_1.isUndefined)(globals_1.window) && 'onLine' in globals_1.window.navigator) {
    ...
    RetryQueue.prototype.retriableRequest = function (_a) {
        ...
        if ((0, type_utils_1.isNumber)(retriesPerformedSoFar) && retriesPerformedSoFar > 0) {

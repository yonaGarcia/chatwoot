...
function splitClassString(s) {
    return s ? (0, string_utils_1.trim)(s).split(/\s+/) : [];
}
...
function makeSafeText(s) {
    if ((0, type_utils_1.isNullish)(s)) {
        return null;
    }
    return ((0, string_utils_1.trim)(s)
...
function getSafeText(el) {
    ...
    return (0, string_utils_1.trim)(elText);
}
function getEventTarget(e) {
    var _a;
    // https://developer.mozilla.org/en-US/docs/Web/API/Event/target#Compatibility_notes
    if ((0, type_utils_1.isUndefined)(e.target)) {
...
function checkIfElementTreePassesElementAllowList(elements, autocaptureConfig) {
    ...
    if ((0, type_utils_1.isUndefined)(allowlist)) {
...
function shouldCaptureElement(el) {
    for (var curEl = el; curEl.parentNode && !(0, element_utils_1.isTag)(curEl, 'body'); curEl = curEl.parentNode) {
        ...
        if ((0, string_utils_1.includes)(classes, 'ph-sensitive') || (0, string_utils_1.includes)(classes, 'ph-no-capture')) {
            return false;
        }
    }
    if ((0, string_utils_1.includes)(getClassNames(el), 'ph-include')) {
        return true;
    }
    // don't include hidden or password fields
    var type = el.type || '';
    if ((0, type_utils_1.isString)(type)) {
    ...
    if ((0, type_utils_1.isString)(name)) {
...
function shouldCaptureValue(value, anchorRegexes) {
    ...
    if ((0, type_utils_1.isString)(value)) {
        value = (0, string_utils_1.trim)(value);
...
function isAngularStyleAttr(attributeName) {
    if ((0, type_utils_1.isString)(attributeName)) {
...
function extractAttrClass(el) {
    ...
    else if ((0, type_utils_1.isArray)(attr_class)) {
        return attr_class;
    }
    else {

...
var WebExperiments = /** @class */ (function () {
            ...
            _this.getWebExperiments(function (webExperiments) {
                ...
                webExperiments.forEach(function (webExperiment) {
                    ...
                    if (webExperiment.feature_flag_key) {
                        ...
                        if ((0, type_utils_1.isString)(selectedVariant) && webExperiment.variants[selectedVariant]) {
    ...
    WebExperiments.prototype.onFeatureFlags = function (flags) {
        ...
        if ((0, type_utils_1.isNullish)(this._flagToExperiments)) {
    ...
    WebExperiments._matchesTestVariant = function (testVariant) {
        if ((0, type_utils_1.isNullish)(testVariant.conditions)) {
            return false;
        }
    ...
    WebExperiments._matchUrlConditions = function (testVariant) {
        var _a, _b, _c, _d;
        if ((0, type_utils_1.isNullish)(testVariant.conditions) || (0, type_utils_1.isNullish)((_a = testVariant.conditions) === null || _a === void 0 ? void 0 : _a.url)) {
            return true;
        }
        var location = WebExperiments.getWindowLocation();
        if (location) {
    ...
    WebExperiments._matchUTMConditions = function (testVariant) {
        ...
        if ((0, type_utils_1.isNullish)(testVariant.conditions) || (0, type_utils_1.isNullish)((_a = testVariant.conditions) === null || _a === void 0 ? void 0 : _a.utm)) {
            return true;
        }

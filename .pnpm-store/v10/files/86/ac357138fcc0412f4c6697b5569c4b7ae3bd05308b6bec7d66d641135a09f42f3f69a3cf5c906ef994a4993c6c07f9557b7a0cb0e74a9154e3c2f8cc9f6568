...
var RequestQueue = /** @class */ (function () {
    function RequestQueue(sendRequest, config) {
        ...
        this._isPaused = true;
        this._queue = [];
        this._flushTimeoutMs = (0, number_utils_1.clampToRange)((config === null || config === void 0 ? void 0 : config.flush_interval_ms) || exports.DEFAULT_FLUSH_INTERVAL_MS, 250, 5000, 'flush interval', exports.DEFAULT_FLUSH_INTERVAL_MS);
        ...
        this._flushTimeout = setTimeout(function () {
            ...
            if (_this._queue.length > 0) {
                ...
                var _loop_1 = function (key) {
                    ...
                    if (req.data && (0, type_utils_1.isArray)(req.data)) {
    ...
    RequestQueue.prototype._formatQueue = function () {
        ...
        (0, utils_1.each)(this._queue, function (request) {
            ...
            if ((0, type_utils_1.isUndefined)(requests[key])) {

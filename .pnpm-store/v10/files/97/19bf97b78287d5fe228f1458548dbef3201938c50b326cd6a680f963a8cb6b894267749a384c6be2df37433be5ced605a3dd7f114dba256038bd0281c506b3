...
var PageViewManager = /** @class */ (function () {
    ...
    PageViewManager.prototype._previousPageViewProperties = function (timestamp, pageviewId) {
        ...
        if (scrollContext && !this._instance.config.disable_scroll_properties) {
            ...
            if (!(0, type_utils_1.isUndefined)(maxScrollHeight) &&
                !(0, type_utils_1.isUndefined)(lastScrollY) &&
                !(0, type_utils_1.isUndefined)(maxScrollY) &&
                !(0, type_utils_1.isUndefined)(maxContentHeight) &&
                !(0, type_utils_1.isUndefined)(lastContentY) &&
                !(0, type_utils_1.isUndefined)(maxContentY)) {
                ...
                var lastScrollPercentage = maxScrollHeight <= 1 ? 1 : (0, number_utils_1.clampToRange)(lastScrollY / maxScrollHeight, 0, 1);
                var maxScrollPercentage = maxScrollHeight <= 1 ? 1 : (0, number_utils_1.clampToRange)(maxScrollY / maxScrollHeight, 0, 1);
                var lastContentPercentage = maxContentHeight <= 1 ? 1 : (0, number_utils_1.clampToRange)(lastContentY / maxContentHeight, 0, 1);
                var maxContentPercentage = maxContentHeight <= 1 ? 1 : (0, number_utils_1.clampToRange)(maxContentY / maxContentHeight, 0, 1);

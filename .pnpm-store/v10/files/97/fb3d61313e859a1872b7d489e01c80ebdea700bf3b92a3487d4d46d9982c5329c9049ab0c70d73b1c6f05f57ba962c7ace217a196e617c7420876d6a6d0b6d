...
var WebVitalsAutocapture = /** @class */ (function () {
    function WebVitalsAutocapture(_instance) {
        ...
        this._addToBuffer = function (metric) {
            ...
            if ((0, type_utils_1.isUndefined)(sessionIds)) {
            ...
            if ((0, type_utils_1.isUndefined)($currentUrl)) {
                return;
            }
            if ((0, type_utils_1.isNullish)(metric === null || metric === void 0 ? void 0 : metric.name) || (0, type_utils_1.isNullish)(metric === null || metric === void 0 ? void 0 : metric.value)) {
            ...
            if ((0, type_utils_1.isUndefined)(_this._buffer.url)) {
                _this._buffer.url = $currentUrl;
            }
            _this._buffer.firstMetricTimestamp = (0, type_utils_1.isUndefined)(_this._buffer.firstMetricTimestamp)
                ? Date.now()
        ...
        this._startCapturing = function () {
            ...
            if (!(0, type_utils_1.isUndefined)(posthogExtensions) && !(0, type_utils_1.isUndefined)(posthogExtensions.postHogWebVitalsCallbacks)) {
                ;
    ...
    Object.defineProperty(WebVitalsAutocapture.prototype, "allowedMetrics", {
        get: function () {
            var _a, _b;
            var clientConfigMetricAllowList = (0, type_utils_1.isObject)(this._instance.config.capture_performance)
                ? (_a = this._instance.config.capture_performance) === null || _a === void 0 ? void 0 : _a.web_vitals_allowed_metrics
                : undefined;
            return !(0, type_utils_1.isUndefined)(clientConfigMetricAllowList)
    ...
    Object.defineProperty(WebVitalsAutocapture.prototype, "flushToCaptureTimeoutMs", {
        get: function () {
            var clientConfig = (0, type_utils_1.isObject)(this._instance.config.capture_performance)
    ...
    Object.defineProperty(WebVitalsAutocapture.prototype, "_maxAllowedValue", {
        get: function () {
            var configured = (0, type_utils_1.isObject)(this._instance.config.capture_performance) &&
                (0, type_utils_1.isNumber)(this._instance.config.capture_performance.__web_vitals_max_value)
    ...
    Object.defineProperty(WebVitalsAutocapture.prototype, "isEnabled", {
        get: function () {
            ...
            var clientConfig = (0, type_utils_1.isObject)(this._instance.config.capture_performance)
                ...
                : (0, type_utils_1.isBoolean)(this._instance.config.capture_performance)
                    ? this._instance.config.capture_performance
                    : undefined;
            return (0, type_utils_1.isBoolean)(clientConfig) ? clientConfig : this._enabledServerSide;
        },
        enumerable: false,
        configurable: true
    });
    ...
    WebVitalsAutocapture.prototype.onRemoteConfig = function (response) {
        var _a, _b;
        var webVitalsOptIn = (0, type_utils_1.isObject)(response.capturePerformance) && !!response.capturePerformance.web_vitals;
        var allowedMetrics = (0, type_utils_1.isObject)(response.capturePerformance)

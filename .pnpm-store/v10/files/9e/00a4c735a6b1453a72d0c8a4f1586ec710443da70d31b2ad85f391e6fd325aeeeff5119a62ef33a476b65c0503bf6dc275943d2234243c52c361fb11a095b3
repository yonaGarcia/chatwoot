...
var removeAuthorizationHeader = function (data) {
    ...
    if (!(0, type_utils_1.isNullish)(headers)) {
...
function scrubPayloads(capturedRequest) {
    if ((0, type_utils_1.isUndefined)(capturedRequest)) {
        return undefined;
    }
...
var buildNetworkRequestOptions = function (instanceConfig, remoteNetworkOptions) {
    ...
    var hasDeprecatedMaskFunction = (0, type_utils_1.isFunction)(instanceConfig.session_recording.maskNetworkRequestFn);
    if (hasDeprecatedMaskFunction && (0, type_utils_1.isFunction)(instanceConfig.session_recording.maskCapturedNetworkRequestFn)) {
    ...
    config.maskRequestFn = (0, type_utils_1.isFunction)(instanceConfig.session_recording.maskCapturedNetworkRequestFn)
        ? function (data) {
            var _a, _b, _c;

...
function autocapturePropertiesForElement(target, _a) {
    ...
    (0, utils_1.each)(targetElementList, function (el) {
        ...
        if ((0, string_utils_1.includes)(classes, 'ph-no-capture')) {
...
var Autocapture = /** @class */ (function () {
    ...
    Object.defineProperty(Autocapture.prototype, "_config", {
        get: function () {
            var _a, _b;
            var config = (0, type_utils_1.isObject)(this.instance.config.autocapture) ? this.instance.config.autocapture : {};
    ...
    Object.defineProperty(Autocapture.prototype, "isEnabled", {
        get: function () {
            ...
            if ((0, type_utils_1.isNull)(memoryDisabled) && !(0, type_utils_1.isBoolean)(persistedServerDisabled) && !this.instance._shouldDisableFlags()) {
    ...
    Autocapture.prototype.isBrowserSupported = function () {
        return (0, type_utils_1.isFunction)(globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.querySelectorAll);
    };
    return Autocapture;
}());

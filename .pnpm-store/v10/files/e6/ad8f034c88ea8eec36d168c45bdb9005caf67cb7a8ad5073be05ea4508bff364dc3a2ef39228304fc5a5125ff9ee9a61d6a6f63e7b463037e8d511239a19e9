...
if (!Number.isInteger) {
    Number.isInteger = function (value) {
        return (0, type_utils_1.isNumber)(value) && isFinite(value) && Math.floor(value) === value;
    };
}
...
var V7Generator = /** @class */ (function () {
    ...
    V7Generator.prototype.generate = function () {
        ...
        if (!(0, type_utils_1.isUndefined)(value)) {
            return value;
        }
        else {
            ...
            if ((0, type_utils_1.isUndefined)(valueAfterReset)) {
...
if (globals_1.window && !(0, type_utils_1.isUndefined)(globals_1.window.crypto) && crypto.getRandomValues) {
